        ...
        module.exports = (function(window, document) {
            ...
            function querySelectorLive(selector, handler, root) {
                ...
                if (simpleSelector.indexOf(':') == -1) {
                    ...
                    // static stuff only
                    eventStream = new DOMUpdateEventStream({
                        target: root
                    });
            ...
            var cssCascade = {
                ...
                getSpecifiedStyle: function getSpecifiedStyle(element, cssPropertyName, matchedRules) {
                    ...
                    if (element.currentStyle && !window.opera) {
                        ...
                        var rules = matchedRules || (
                            cssPropertyName in cssCascade.monitoredProperties ? element.myMatchedRules || [] : cssCascade.findAllMatchingRules(element)
                        );
                ...
                startMonitoringProperties: function startMonitoringProperties(properties, handler) {
                    ...
                    for (var i = properties.length; i--;) {
                        ...
                        var handlers = (
                            cssCascade.monitoredProperties[property] || (cssCascade.monitoredProperties[property] = [])
                        );
        ...
        module.exports = (function(window, document) {
            ...
            var cssBreak = {
                ...
                isScrollable: function isScrollable(element, elementOverflow) {
                    ...
                    return (
                        elementOverflow !== "visible" && elementOverflow !== "hidden"
                    );
                ...
                isSingleLineOfTextComponent: function(element, elementStyle, elementDisplay, elementPosition, isReplaced) {
                    ...
                    return (
                        elementDisplay === "inline-block" || elementDisplay === "inline-table" || elementDisplay === "inline-flex" || elementDisplay === "inline-grid"
                        // TODO: more
                    ) && (
                ...
                isLineBreakingElement: function(element, elementStyle, elementDisplay, elementPosition) {
                    ...
                    return (
                        (
                            ...
                            (elementDisplay === "block") && !this.isOutOfFlowElement(element, elementStyle, elementDisplay, elementPosition)
                ...
                isLinePreBreakingElement: function(element, elementStyle, elementDisplay, elementPosition) {
                    ...
                    return (
                        (breakBefore == "region" || breakBefore == "all") || cssBreak.isLineBreakingElement(element, elementStyle, elementDisplay, elementPosition)
                    );
                ...
                isLinePostBreakingElement: function(element, elementStyle, elementDisplay, elementPosition) {
                    ...
                    return (
                        (breakAfter == "region" || breakAfter == "all") || cssBreak.isLineBreakingElement(element, elementStyle, elementDisplay, elementPosition)
                    );
                        ...
                        switch (node.nodeType) {
                            case 1: // Element node
                                ...
                                if (typeof(k) == "undefined" || !ignoreRoot) {
                                    ...
                                    if (!id) {
                                        node.setAttribute('data-css-regions-fragment-source', cssRegionsHelpers.fragmentSourceIndex++);
                                    }
                                ...
                                var importPseudo = function(node1, node2, pseudo) {
                                    ...
                                    if (pseudoStyle.content != 'none') {
                                        ...
                                        stylesheet.textContent = (
                                            '[data-css-regions-fragment-of="' + node1.getAttribute('data-css-regions-fragment-source') + '"]' + ':not([data-css-regions-starting-fragment]):not([data-css-regions-special-starting-fragment])' + ':' + pseudo + '{' + node2style + "}"
                                        );
        ...
        module.exports = (function(window, document, cssRegions) {
                    ...
                    cssRegions.layoutContent(regionStack, contentFragment, {
                        ...
                        ondone: function onLayoutDone(overset) {
                            ...
                            if (This.regions.length > 0 && !This.restartLayout) {
                                ...
                                var isBuggy = false;
                                isBuggy = isBuggy || This.regions.some(function(e) {
                                    return !document.documentElement.contains(e);
                                })
                                isBuggy = isBuggy || This.content.some(function(e) {
                                    return !document.documentElement.contains(e);
                                })
            ...
            cssRegions.Flow.prototype.relayoutIfSizeChanged = function() {
                ...
                for (var i = rs.length; i--;) {
                    if (
                        rs[i].offsetHeight !== rs[i].cssRegionsLastOffsetHeight || rs[i].offsetWidth !== rs[i].cssRegionsLastOffsetWidth
                    ) {
                        this.relayout();
                        return;
                    }
                ...
                extractOverflowingContent: function(region, dontOptimize) {
                    ...
                    if (r.endOffset == r.endContainer.childNodes.length && r.endContainer !== region) {
                        ...
                        if (typeof(borderCut) === "number" && borderCut !== 0) {
                            ...
                            var hasBottomRadius = (
                                parseInt(endContainerStyle.borderBottomLeftRadius) > 0 || parseInt(endContainerStyle.borderBottomRightRadius) > 0
                            );
                    ...
                    cssCascade.startMonitoringProperties(
                        ["flow-into", "flow-from", "region-fragment"], {
                            onupdate: function onupdate(element, rule) {
                                ...
                                if (flowIntoName == "none" || flowIntoName == "initial" || flowIntoName == "inherit" || flowIntoName == "default") {
                                    flowIntoName = ""
                                }
                                ...
                                if (flowFromName == "none" || flowFromName == "initial" || flowFromName == "inherit" || flowFromName == "default") {
                                    flowFromName = ""
                                }
